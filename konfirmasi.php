...
if($konfirmasi == 'ya'){
    ...
    $message = "Terima kasih Bapak / Ibu %20".ucwords($nama).", sudah melakukan konfirmasi kehadiran. %0A%0ABerikut adalah tiket masuk digital anda, Silahkan Scan Tiket ini di Pintu Masuk untuk mendapatkan tempat duduk yg telah disediakan. %0A%0A- Mohon membawa %20Hasil tes Antigen Maksimal %20H-2. %0A%0A- Akses parkir mobil di Pakuwon Mall : Basement B3 kemudian menuju lift Ballroom Westin (pilih Lantai M1)";
    // dd($message);
